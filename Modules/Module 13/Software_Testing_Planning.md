...
A comprehensive checklist to help you think about your project, identify potential gaps, and generate new ideas for your testing approach.
...
*There should only be two or three lines under each section, just enough to give an overview of what will be done.*

![One Page Test Plan Dashboard](/Images/one_page_test_plan.png)

![Test Plan Example](/Images/test_plan_example.png)


---

## 2. Outputs of Testing

*What are the outputs of testing?*  
With agile-type approaches to working, it can be increasingly hard to physically show the output of testing.
...
*The types of testing available can help you define what type of testing needs to happen. Most software testing plans don’t cover all of these at once.*
...
## 4. Software Testing Plan Formats

*Consider how you will communicate that plan…*
...
![Mindmaps](/Images/mind_maps_epic.png)
---
...
- Are you aware of the business and technology processes that help the project move forward?
...
- How and with whom can you share knowledge?
...
*Every testing effort needs resources. Do you know what resources you have access to?*
...
## 11. What is the Software Capable Of?
